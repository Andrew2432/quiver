...
import usePostsCategories from '../../utils/hooks/usePostsCategories';
...
function BlogCategoriesPosts({ slug }: Props): JSX.Element {
  const perPage = 5;
  ...
  const {
    ...
    isLoading,
    mutate,
  } = usePostsCategories(pageRef.current.currentPage, perPage, slug);
