      ...
      <Row className={`my-2 p-2`}>
        <Col>
          ...
          <Row className={`my-3`}>
            <Col>
              <p>
                At Andrew Joel, accessible from{' '}
                ...
                is collected and recorded by Andrew Joel and how we use it. If
                ...
                they shared and/or collect in Andrew Joel. This policy is not
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                ...
                <br />
                <br /> When you register for an Account, we may ask for your
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                Andrew Joel follows a standard procedure of using log files.
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                Like any other website, Andrew Joel uses 'cookies'. These
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                ...
                the advertising partners of Andrew Joel. <br />
                <br /> Third-party ad servers or ad networks uses technologies
                like cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on Andrew Joel,
                which are sent directly to users' browser. They automatically
                receive your IP address when this occurs. These technologies are
                used to measure the effectiveness of their advertising campaigns
                and/or to personalize the advertising content that you see on
                websites that you visit. <br />
                <br /> Note that Andrew Joel has no access to or control over
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                Andrew Joel's Privacy Policy does not apply to other advertisers
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                ...
                the right to: <br />
                <br /> Request that a business that collects a consumer's
                ...
                <br />
                <br /> If you make a request, we have one month to respond to
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                ...
                <br />
                <br />
                Andrew Joel does not knowingly collect any Personal Identifiable
