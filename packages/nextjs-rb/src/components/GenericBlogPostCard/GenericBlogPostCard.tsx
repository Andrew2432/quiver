...
import { GenericBlogPostCardProps } from './GenericBlogPostCardProps';

const { useContext } = React;

function GenericBlogPostCard({ post }: GenericBlogPostCardProps) {
...
export default GenericBlogPostCard;
