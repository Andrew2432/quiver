      ...
      <Row className={`my-2 p-2`}>
        <Col>
          ...
          <Row className={`my-3`}>
            <Col>
              <p>
                Welcome to Andrew Joel!
                <br />
                <br />
                These terms and conditions outline the rules and regulations for
                the use of Andrew Joel's Website, located at{' '}
                <a href={`https://andrew-joel.com`} rel={`noreferrer noopener`}>
                ...
                conditions. Do not continue to use Andrew Joel if you do not
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                We employ the use of cookies. By accessing Andrew Joel, you
                agreed to use cookies in agreement with the Andrew Joel's
                Privacy Policy.
                <br />
                <br />
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                Unless otherwise stated, Andrew Joel and/or its licensors own
                the intellectual property rights for all material on Andrew
                Joel. All intellectual property rights are reserved. You may
                access this from Andrew Joel for your own personal use subjected
                to restrictions set in these terms and conditions.
                <br />
                <br />
                You must not:
                <ul className={`mx-3`}>
                  <li>Republish material from Andrew Joel</li>
                  <li>Sell, rent or sub-license material from Andrew Joel</li>
                  <li>
                    Reproduce, duplicate or copy material from Andrew Joel
                  </li>
                  <li>Redistribute content from Andrew Joel</li>
                </ul>
                ...
                website. Andrew Joel does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Andrew Joel,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Andrew Joel shall not be liable
                ...
                <br />
                <br />
                Andrew Joel reserves the right to monitor all Comments and to
                ...
                You hereby grant Andrew Joel a non-exclusive license to use,
          ...
          <Row className={`my-3`}>
            <Col>
              ...
              <p>
                ...
                of Andrew Joel; and (d) the link is in the context of general
                ...
                by sending an e-mail to Andrew Joel. Please include your name,
                ...
                No use of Andrew Joel's logo or other artwork will be allowed
